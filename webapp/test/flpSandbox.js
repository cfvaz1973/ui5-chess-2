		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Chess",
									"targetURL": "#ui5futureviewui5chess2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5futureviewui5chess2-display": {
								"semanticObject": "ui5futureviewui5chess2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.futureview.ui5chess2",
									"url": sap.ui.require.toUrl("ui5/futureview/ui5chess2")
								}
							}
						}
					}
